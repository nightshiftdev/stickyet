...
#define kMainTheme @"sticky-et-main-theme.mp3"

#define kBlueTheme @"sticky-et-blue-world.mp3"

#define kGreenTheme @"sticky-et-green-world.mp3"

#define kRedTheme @"sticky-et-red-world.mp3"

#define kGameCompleteTheme @"sticky-et-game-complete.mp3"
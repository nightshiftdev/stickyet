...
@interface StickyETAppDelegate (Sounds)
-(void) initSounds;
@end

@implementation StickyETAppDelegate
...
- (void)initSounds {
	...
	[[SimpleAudioEngine sharedEngine] preloadEffect:@"button-pressed.wav"];
	[[SimpleAudioEngine sharedEngine] setBackgroundMusicVolume: 0.75f];
